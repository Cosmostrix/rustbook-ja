...
各<ruby>場合値<rt>バリアント</rt></ruby>は、符号付きまたは符号なしのいずれかであり、明示的なサイズを持ちます。
...
|<!--Number literals-->数<ruby>直書き<rt>リテラル</rt></ruby>|<!--Example-->例|
|------------------|---------------|
|<!--Decimal-->小数|`98_222`|
|<!--Hex-->ヘキサ|`0xff`|
|<!--Octal-->オクタル|`0o77`|
...
この<ruby>算譜<rt>プログラム</rt></ruby>は最初に組を作成し、それを変数`tup`ます。
