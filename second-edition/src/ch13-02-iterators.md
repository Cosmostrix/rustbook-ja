...
反復子は、各項目の反復処理の論理と、シーケンスがいつ終了したかを判断します。
反復子ーを使用する場合、その論理を自分自身で再実装する必要はありません。
...
反復子はあなたのためにすべての論理を処理し、潜在的に混乱する可能性のある繰り返し譜面を減らします。
反復子ーは、ベクトルのように添字を付けることができるデータ構造だけでなく、さまざまな種類のシーケンスで同じ論理を使用する柔軟性を提供します。
...
上で定義されたその他の方法`Iterator` *反復子アダプタ*として知られている特徴は、反復子の異なる種類に反復子を変更することができます。
